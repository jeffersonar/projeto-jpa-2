		...
		template.execute(new TransactionCallbackWithoutResult() {
			...
			protected void doInTransactionWithoutResult(TransactionStatus status) {
				...
				livroDeArquitetura.setDescricao("Neste livro, os autores, conhecidos especialistas da "
											   ...
											   + "  Sempre com uma visão tÃ©cnica e pratica capaz de elucidar muitas "
											   + "questões enfrentadas tanto pelo profissional iniciante quanto por "
											   + "aquele que estão adquirindo mais experiencia na plataforma.");
				...
				livroDeSpring.setDescricao("Criado para simplificar o desenvolvimento de aplicações Java, "
						...
						+ "Aprenda muito mais que o basico do Spring, desde o tradicional Container de Inversão "
						+ "de Controle e injeção de Dependencias, passando pelos robustos modulos de segurança, "
						+ "transações, programação orientada a aspectos e tambem o fantastico modulo MVC, o SpringMVC.");
